...
public class GoldRushLocation implements Parcelable {
    ...
    private GoldRushLocation(Parcel in) {
        id = in.readLong();
        title = in.readString();
        tour = in.readString();
    ...
    public static final Creator<GoldRushLocation> CREATOR = new Creator<GoldRushLocation>() {
        public GoldRushLocation createFromParcel(Parcel in) {
            return new GoldRushLocation(in);
        }

        public GoldRushLocation[] newArray(int size) {
            return new GoldRushLocation[size];
        }
    };
